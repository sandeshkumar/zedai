...
export const CITY_SERVICE_CONTENT: CityServiceContent[] = [
  ...
  },
  {
    ...
    localFaqs: [
      ...
      { question: "Can AI help my small business in Jaipur?", answer: "Yes. AI is most impactful for small businesses — automating repetitive tasks like customer queries, appointment booking, invoice generation, and follow-ups. The ROI is typically 3-5X within 6 months." },
