...
export const SERVICES: ServiceItem[] = [
  {
    ...
    features: [
      { title: "Mobile-First Design", description: "Every site is built mobile-first because 70%+ of your visitors come from phones." },
      { title: "SEO Built-In", description: "On-page SEO, schema markup, and fast Core Web Vitals to rank higher from launch." },
    ...
    faqs: [
      ...
      { question: "Will my custom website rank on Google?", answer: "Yes. Every website we build includes on-page SEO, schema markup, fast Core Web Vitals, and mobile-first design. These are all factors Google uses for rankings." },
    ],
  },
  {
    ...
    features: [
      { title: "Payment Gateways", description: "Razorpay, PhonePe, UPI, cards, and net banking. Every way your customers want to pay." },
      { title: "Inventory Management", description: "Track stock, manage variants, and set alerts so you never oversell or run out." },
    ...
    benefits: [
      ...
      "Accept UPI, cards, and net banking, all payment modes",
  ...
  },
  {
    ...
    features: [
      { title: "Cross-Platform", description: "One codebase for Android & iOS for faster delivery, lower cost, and same quality." },
      { title: "Push Notifications", description: "Re-engage users with targeted push notifications that drive retention." },
      { title: "Offline Support", description: "Your app works even without internet, which is critical for Indian users." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Sales Pipeline", description: "Visual deal pipeline where you drag and drop leads through your sales stages." },
    ...
    benefits: [
      "Never lose a lead because every enquiry is tracked",
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Kitchen Display", description: "Digital KOT system where orders go straight from POS to kitchen screens." },
  ...
  },
  {
    ...
    icon: "🦾",
    title: "AI Agents",
    description: "Custom agents that take actions, not just chat. Qualify leads, book slots, file invoices, escalate when stuck.",
    formServiceName: "AI Agent",
    heroTitle: "AI agents that work in production, not in demos",
    heroDescription: "We build agents on Claude, GPT-4, and open-source models that handle real tasks across WhatsApp, email, and your internal tools. You stay in control, the agent does the repetitive work.",
    features: [
      { title: "Sales & Lead Qualification", description: "Agents that reply on WhatsApp, ask qualifying questions, book Calendly slots, and push warm leads to your CRM." },
      { title: "Tier-1 Support", description: "Trained on your help docs and past tickets. Resolves common issues, escalates complex ones with full context." },
      { title: "Invoice & Document Processing", description: "Reads invoices from email, files them in Tally or Zoho Books, flags duplicates and amount mismatches." },
      { title: "Voice Agents", description: "Inbound and outbound voice calls on Twilio or Vapi. Handles bookings, follow-ups, and basic support in English and Hindi." },
      { title: "Internal Ops", description: "Agents that pull data from spreadsheets, summarise meetings, generate reports, or onboard new hires through Slack/WhatsApp." },
      { title: "Human-in-the-Loop Controls", description: "Every agent has approval gates for high-stakes actions. You decide where it acts on its own and where it asks first." },
    ],
    benefits: [
      "Cut response time on inbound enquiries from hours to seconds",
      "Free your team from repetitive tickets and data entry",
      "Run 24/7 without hiring a night shift",
      "Audit trails on every action the agent takes",
    ...
    faqs: [
      { question: "What's the difference between an AI agent and a chatbot?", answer: "A chatbot answers questions. An agent takes actions: it books a meeting, files an invoice, or escalates a ticket with the full thread attached. Agents call tools and APIs. Chatbots reply with text." },
      { question: "Which models do you build agents on?", answer: "Depends on the job. Claude for long-context reasoning and tool use. GPT-4 for breadth and ecosystem. Open-source (Llama, Qwen) when data has to stay on your servers. We pick after a scoping call, not by default." },
      { question: "How much does a production AI agent cost?", answer: "Scoped agents start at ₹1,50,000 for a single workflow (eg. WhatsApp lead qualifier). Multi-step agents with CRM, calendar, and human approval flows range from ₹3,00,000 to ₹10,00,000 plus monthly LLM API costs." },
      { question: "Can the agent stay on our servers?", answer: "Yes. We deploy on your AWS, Azure, or GCP account. For sensitive data we use open-source models running on your infrastructure so nothing leaves your network." },
    ],
  },
  {
    slug: "ai-solutions",
    ...
    features: [
      ...
      { title: "Process Automation", description: "Automate repetitive tasks like data entry, reports, emails, and workflows." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Analytics & Tracking", description: "Full-funnel tracking so you know exactly which campaigns drive revenue." },
  ...
  },
  {
    ...
    benefits: [
      ...
      "Reduce development costs by fixing problems in design, not code",
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Auto-Scaling", description: "Handle traffic spikes automatically and pay only for what you use." },
  ...
  },
  {
    ...
    description: "Annual maintenance contracts with updates, security patches, monitoring, and priority support to keep your software running perfectly.",
    ...
    benefits: [
      ...
      "Priority support with no waiting in queues",
...
export const PRICING_TIERS = [
  {
    name: "Starter",
    description: "Get online fast with AI built in",
    oldPrice: "₹40,000",
    price: "₹24,999",
  ...
  {
    name: "Growth",
    description: "For businesses serious about leads & revenue",
    oldPrice: "₹1,00,000",
    price: "₹59,999",
    priceSuffix: "one-time",
    popular: true,
  ...
  {
    name: "Enterprise",
    description: "Apps, eCommerce & custom platforms",
    oldPrice: null,
    price: "₹99,999",
    ...
    features: [
      ...
      "API Integrations (ERP, CRM, POS)",
      "Dedicated Project Manager",
      "90-Day Support + AMC Options",
    ],
