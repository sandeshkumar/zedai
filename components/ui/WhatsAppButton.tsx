...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-[200] w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.3)] hover:scale-[1.08] transition-transform cursor-pointer"
      initial={{ scale: 0 }}
      animate={{ scale: 1 }}
