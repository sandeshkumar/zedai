        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {RESULTS.map((item, i) => (
            <ScrollReveal key={item.label} delay={i * 0.1}>
              <div className="bg-card border border-border-subtle rounded-[var(--radius-lg)] p-8 text-center transition-all duration-300 hover:-translate-y-1 hover:border-border-blue hover:shadow-[0_0_25px_rgba(249,115,22,0.08)]">
