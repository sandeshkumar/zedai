    ...
    <header className="fixed top-0 w-full z-[200]">
      ...
      >
        <span className="relative z-[1]">
          🎁 <span className="inline-block bg-white text-accent-dark text-[0.7rem] font-extrabold uppercase px-2 py-0.5 rounded-[4px] mx-1 tracking-[0.06em]" style={{ animation: "blink 2s ease-in-out infinite" }}>Limited Offer</span> FREE Domain & Hosting for 1 Year with every plan! <span className="hidden sm:inline">→</span>
        </span>
        <span
